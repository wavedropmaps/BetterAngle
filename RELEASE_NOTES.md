...
_First full release of the 7.x line (v7.0.0 went out as a pre-release by mistake; this is the same build). v6.0.5 and v6.0.6 were never released, so this includes everything below._
